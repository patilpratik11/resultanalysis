<%-- 
    Document   : manage_faculty
    Created on : Oct 1, 2018, 2:45:02 PM
    Author     : pRaTiK
--%>
            ...
            <div class="card-deck mx-auto w-75">
                ...
                <div class="card d-block shadow p-4 mb-4 bg-white">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">REGISTER NEW FACULTY</p>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h4 class="modal-title ">ENTER FACULTY DETAILS</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>

                                    <!-- Modal body -->
                                    <div class="modal-body">
                                        <form action="../process_pages/register_faculty.jsp" method="post">
                                            <div class="form-group">
                                                <label class="lead float-left">Faculty Id:</label>
                                            ...
                                            <div class="form-group">
                                                <label class="lead float-left">Email address:</label>
                ...
                <div class="card d-block shadow p-4 mb-4 bg-white">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">REMOVE EXISTING FACULTY</p>
                        ...
                        <div class="modal fade" id="myModal1">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title ">ENTER FACULTY CODE CAREFULLY</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>

                                    <!-- Modal body -->
                                    <div class="modal-body">
                                        <form action="../process_pages/remove_faculty.jsp" method="post">
                                            <div class="form-group">
                                                <label class="lead float-left">Faculty Code:</label>
                                                <input type="text" class="form-control" name="eid" required>
                                            </div>
                                            <button type="button" class="btn btn-outline-danger mx-auto d-block float-right m-3" data-dismiss="modal">CLOSE</button>
                                            <button type="submit" onClick='if (!checkdropdown()) {
