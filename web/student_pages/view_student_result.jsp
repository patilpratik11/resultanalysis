...
<html>
    <head>
        ...
        <title>Result Without Backlog</title>
    ...
    <%
        ...
        ResultSet rs3 = st.executeQuery("SELECT * FROM resultanalysis.result_main where student_details_prn='" + prn + "' and sem_no='" + sem + "'");
        rs3.next();
        Integer rno = rs3.getInt("result_marks_id");
        String eno = rs3.getString("exam_seat_no");
        String year = rs3.getString("year_attempting");

        ResultSet rs5 = st.executeQuery("SELECT * FROM resultanalysis.result_main where student_details_prn='" + prn + "' and sem_no='" + sem + "'");
    ...
    <div class="container">
        ...
        <br>
        <center>
            <h5>Exam seat no: <%=eno%>  &nbsp  Sem no:<%=s%>  &nbsp Year:<%=year%></h5>
        </center>
        <br>         
